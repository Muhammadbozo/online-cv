<template>
  <div>
    <div class="container">
      <div class="row">
        <div class="col-4">
          <div :style="myStyle2"><h2>EDUCATION</h2></div>
        </div>
        <div class="col-8">
          <div>
            <b-card
      ...
      <div class="row">
        <div class="col-4">
          <div :style="myStyle3"><h2>WORK</h2></div>
        </div>
        <div class="col-8">
          <div>
            <b-card
      ...
      <div class="row">
        <div class="col-4">
          <div :style="myStyle3"><h2>SKILLS</h2></div>
        </div>
        <div class="col-8">
          <div>
            <b-card
      ...
      <div class="text-center">
        <b-button
          ...
          href="/about"
        >
          <router-link :style="myStyle4" to="/projects"
            >Check out my portfolio</router-link
          >
        </b-button>
      </div>
    </div>
